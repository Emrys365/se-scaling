...
from espnet2.enh.separator.crossnet_separator import CrossNetSeparator
...
from espnet2.enh.separator.demucsv4_separator import HTDemucs
...
criterion_choices = ClassChoices(
    ...
    classes=dict(
        ...
        mse_mag_fd=FrequencyDomainMagnitudeMSE,
